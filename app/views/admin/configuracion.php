...
<?php foreach($data['configuraciones'] as $config): ?>
...
<input type="text" value="<?= $config['nombre_rol'] ?>" disabled>
...
<input 
type="number"
name="dias_prestamo[<?= $config['id_config'] ?>]"
...
type="number"
step="0.01"
name="multa_dia[<?= $config['id_config'] ?>]"
value="<?= $config['multa_dia'] ?>"
required>
